...
orderRouter.post('/list', adminAuth_1.default, order_controller_1.allOrders);
orderRouter.post('/status', adminAuth_1.default, order_controller_1.updateStatus);
//payment method
orderRouter.post('/place', order_controller_1.placeOrder);
...
//user order
orderRouter.get('/userorders', adminAuth_1.default, order_controller_1.userOrders);
